    ...
    projects.forEach((project, index) => {
        ...
        card.innerHTML = `
            ...
            <div class="product-actions">
                ${project.link.includes('.apk') ? 
                    `<button class="btn-download" onclick="downloadProject('${project.link}', '${project.title}')">DOWNLOAD NOW</button>` :
                    `<button class="btn-open" onclick="openProject('${project.link}', '${project.title}')">VISIT SITE</button>`
                }
            </div>
        `;
...
function downloadProject(url, title) {
    ...
    console.log('✅ User logged in - allowing download:', title);
    showNotification(`✅ Download initiated for ${title}`);
    window.location.href = url;
}

// Open project in new tab - Requires login
function openProject(url, title) {
    ...
    console.log('✅ User logged in - allowing visit:', title);
